...
interface ShortFormFactoryAgentProps {
  onBack: () => void;
}

export const ShortFormFactoryAgent: React.FC<ShortFormFactoryAgentProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Short Form Factory</h1>
          <p className="text-muted-foreground">Turn any track into viral content</p>
        </div>
      </div>
      ...
      {musicItems.length > 0 && (
        <div>
          <h2 className="text-xl font-bold text-foreground mb-4">Your Content Projects</h2>
