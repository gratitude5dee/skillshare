...
export const BookyAgent: React.FC<BookyAgentProps> = ({ onBack }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-foreground">Booky</h1>
          <p className="text-muted-foreground">DeepBooking Platform</p>
        </div>
      </div>
