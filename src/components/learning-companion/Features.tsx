  ...
  return (
    <div className="self-center flex w-full flex-col items-center pt-10 pb-20 max-md:max-w-full">
      <div className="w-[720px] max-w-full text-[45px] text-[#0a0e09] font-black text-center leading-[39px] py-3 max-md:max-w-full max-md:text-[40px] max-md:leading-[38px]">
        WORK SHOULDN'T FEEL OVERWHELMING ANYMORE.
      </div>
      <div className="flex w-[1222px] max-w-full gap-[24px_0px] justify-between flex-wrap mt-2 py-2.5">
        <FeatureCard
          title="AI-Powered Answers"
          description="Get instant, accurate answers to complex work challenges backed by advanced AI technology."
          buttonText="Ask AI anything"
          illustration={verifiedQAIllustration}
        />
        <FeatureCard
          title="Work Templates"
          description="Transform your workflow with AI-generated templates and automation solutions."
          buttonText="Create templates"
          illustration={worksheetsIllustration}
        />
        <FeatureCard
          title="Project Planning"
          description="Plan and execute projects efficiently with AI-driven insights and strategic guidance."
          buttonText="Start planning"
          illustration={testPrepIllustration}
        />
        <FeatureCard
          title="AI Assistance"
          description="Get 24/7 AI support for any work challenge, from strategy to execution."
